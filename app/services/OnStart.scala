...
class OnStartImpl @Inject() (appLifecycle: ApplicationLifecycle) extends OnStart {
  ...
  def createProducts(): List[Product] = {
    ...
    products = Product.saveOrUpdate(Product(ProductCreate("Harina Blancaflor", Option("http://www.molinos.com.ar/media/17852/Blancaflor-Leudante_producto.jpg"), "La marca pionera que creó la famosa harina leudante aportandole practicidad al amasado casero. Desde hace más de 55 años sigue siendo la compañía indispensable de varias generaciones de cocineras argentinas, que disfrutan cocinar. Blancaflor ofrece un resultado garantizado para quienes cocinan y amasan con un producto único.", 200, isValidated = false, 1, 1, 1))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Harina Blancaflor", Option("http://www.molinos.com.ar/media/17852/Blancaflor-Leudante_producto.jpg"), "La marca pionera que creó la famosa harina leudante aportandole practicidad al amasado casero. Desde hace más de 55 años sigue siendo la compañía indispensable de varias generaciones de cocineras argentinas, que disfrutan cocinar. Blancaflor ofrece un resultado garantizado para quienes cocinan y amasan con un producto único.", 230, isValidated = true, 2, 1, 1))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Harina Blancaflor", Option("http://www.molinos.com.ar/media/17852/Blancaflor-Leudante_producto.jpg"), "La marca pionera que creó la famosa harina leudante aportandole practicidad al amasado casero. Desde hace más de 55 años sigue siendo la compañía indispensable de varias generaciones de cocineras argentinas, que disfrutan cocinar. Blancaflor ofrece un resultado garantizado para quienes cocinan y amasan con un producto único.", 330, isValidated = true, 3, 1, 1))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("ChupaPops", Option("https://res.cloudinary.com/dm8ly2rci/image/upload/c_fill,dpr_auto,f_auto,q_auto:eco,w_750/v1/chupachups.co.uk/2017-10/TBO-lollypops"), "\nChupachús de la marca Chupa Chups.\nUn chupachús, chupeta, chupete o chupetín es un caramelo duro y colorido de unos 2 a 3 cm de diámetro, de forma esférica u oval, con un palito insertado en el centro de la esfera que sirve para sostenerlo. Puede ser macizo o estar relleno de chicle, chocolate, etc.", 50, isValidated = false, 2, 1, 2))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("ChupaPops", Option("https://res.cloudinary.com/dm8ly2rci/image/upload/c_fill,dpr_auto,f_auto,q_auto:eco,w_750/v1/chupachups.co.uk/2017-10/TBO-lollypops"), "\nChupachús de la marca Chupa Chups.\nUn chupachús, chupeta, chupete o chupetín es un caramelo duro y colorido de unos 2 a 3 cm de diámetro, de forma esférica u oval, con un palito insertado en el centro de la esfera que sirve para sostenerlo. Puede ser macizo o estar relleno de chicle, chocolate, etc.", 70, isValidated = true, 1, 1, 2))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Coca Cola", Option("https://cdn.shopify.com/s/files/1/0706/6309/products/mayoreototal-caja-refresco-coca-cola-de-600-ml-con-24-botellas-coca-cola-refrescos-coca-cola-sku_large.jpg?v=1518347710"), "Caja de refresco Coca Cola en 24 botellas de 600 cada una de Coca-Cola.\nEs una deliciosa bebida refrescante y revitalizante, ayudara para quitar la sed además de su tradicional sabor.", 232, isValidated = true, 3, 1, 3))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Coca Cola", Option("https://cdn.shopify.com/s/files/1/0706/6309/products/mayoreototal-caja-refresco-coca-cola-de-600-ml-con-24-botellas-coca-cola-refrescos-coca-cola-sku_large.jpg?v=1518347710"), "Caja de refresco Coca Cola en 24 botellas de 600 cada una de Coca-Cola.\nEs una deliciosa bebida refrescante y revitalizante, ayudara para quitar la sed además de su tradicional sabor.", 202, isValidated = true, 1, 1, 3))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Poet Limpiapisos", Option("https://www.como-limpiar.com/wp-content/uploads/2010/07/poett1.jpg"), "Lo mejor para el cuidado de los  pisos de madera con una capa de D D es limpiarlos regularmente con un trapo humedecido con agua y jabón, o en tal caso con agua y algún desodorante líquido para piso que sea suave como el Poet.", 72, isValidated = false, 2, 1, 4))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Poet Limpiapisos", Option("https://www.como-limpiar.com/wp-content/uploads/2010/07/poett1.jpg"), "Lo mejor para el cuidado de los  pisos de madera con una capa de D D es limpiarlos regularmente con un trapo humedecido con agua y jabón, o en tal caso con agua y algún desodorante líquido para piso que sea suave como el Poet.", 70, isValidated = true, 3, 1, 4))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Mr Musculo Cocina", Option("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2-t2UrMRIc-6z07CQxMUMloe6Y99WMpdX87TltYet46pI9w_23Q"), "Limpia múltiples manchas de cocina. Es multisuperficies.", 170, isValidated = true, 1, 1, 5))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Mr Musculo Cocina", Option("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR2-t2UrMRIc-6z07CQxMUMloe6Y99WMpdX87TltYet46pI9w_23Q"), "Limpia múltiples manchas de cocina. Es multisuperficies.", 170.5, isValidated = true, 3, 1, 5))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Disfraz Mr Musculo", Option("http://www.disfracesflorencia.com.ar/images/mrmusculo.jpg"), "Disfraz completo de Mr Musculo.", 17250, isValidated = true, 2, 1, 6))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Samsung S9", Option("https://cdn.shopify.com/s/files/1/0259/1735/products/samsung_galaxy_s9_phone_template_2048x.jpg?v=1525770901"), "Comparte la pantalla en las otras pantallas de Samsung, sin complicaciones.\nComparte fácilmente fotos y vídeos con la sincronización de tus dispositivos a través de tu cuenta Samsung. Así que puedes estar en casa aun si estás en otro lugar.", 50000, isValidated = true, 2, 1, 7))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Samsung S9", Option("https://cdn.shopify.com/s/files/1/0259/1735/products/samsung_galaxy_s9_phone_template_2048x.jpg?v=1525770901"), "Comparte la pantalla en las otras pantallas de Samsung, sin complicaciones.\nComparte fácilmente fotos y vídeos con la sincronización de tus dispositivos a través de tu cuenta Samsung. Así que puedes estar en casa aun si estás en otro lugar.", 48000, isValidated = true, 1, 1, 7))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Samsung LED 32", Option("https://www.ripley.com.pe/wcsstore/ripleype_CAT_AS/Attachment/WOP/2018168647492/2018168647492-1.jpg"), "Descubre una nueva manera de ver televisión con el TV 32J4300 de Samsung. Este innovador televisor inteligente de 32 pulgadas te brindará imágenes increíbles y podrás disfrutar de tus programas o películas favoritas en una gran pantalla. No esperes más para adquirir este televisor HD solo en Carrefour", 16000, isValidated = true, 2, 1, 8))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Equipo de Musica Noblex", Option("https://d2p3an6os91m4y.cloudfront.net/app/public/spree/products/232/gallery_large/7796962121206-1.jpg?1470945130"), "El equipo de audio Noblex Mnx121 es un completo sistema de sonido de alta definición que te brinda nada menos que 1500W de potencia mediante dos parlantes. Para tu comodidad incorpora un control remoto con amplias funciones, y un lector de tarjetas de memoria para que puedas compartir tus archivos de sonido de forma práctica y sencilla. ", 21000, isValidated = true, 3, 1, 9))).get :: products
    products = Product.saveOrUpdate(Product(ProductCreate("Equipo de Musica Noblex", Option("https://d2p3an6os91m4y.cloudfront.net/app/public/spree/products/232/gallery_large/7796962121206-1.jpg?1470945130"), "El equipo de audio Noblex Mnx121 es un completo sistema de sonido de alta definición que te brinda nada menos que 1500W de potencia mediante dos parlantes. Para tu comodidad incorpora un control remoto con amplias funciones, y un lector de tarjetas de memoria para que puedas compartir tus archivos de sonido de forma práctica y sencilla. ", 21500, isValidated = true, 2, 1, 9))).get :: products
    products
  }
